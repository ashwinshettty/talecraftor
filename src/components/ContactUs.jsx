...
const ContactUs = () => {
  ...
  return (
    <section id="contact" className="mt-16 mb-20 md:mb-18 relative">
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm">
          <div className="bg-white p-8 rounded-2xl shadow-2xl text-center max-w-md mx-4">
            ...
            <button
              ...
              className="bg-[#F87666] hover:bg-[#e86a5a] text-white font-semibold py-2 px-6 rounded-lg transition-colors duration-300"
            >
              Close
            </button>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3">
            ...
            <div className="p-8 text-center md:text-left">
              ...
              <div className="flex justify-center md:justify-start space-x-4">
                <a href="https://www.instagram.com/talecraftor/" target="_blank" rel="noopener noreferrer" className="text-[#143642] hover:text-[#F87666] transition-colors">
                ...
                <a href="https://www.linkedin.com/company/talecraftor/" target="_blank" rel="noopener noreferrer" className="text-[#143642] hover:text-[#F87666] transition-colors">
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
