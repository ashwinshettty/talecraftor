        ...
        <div className="flex flex-col md:flex-row min-h-screen">
          ...
          <div className="w-full md:w-1/2 flex items-center justify-center py-8 md:py-0 md:ml-[-70px]">
            <img 
              ...
              className="w-full h-auto max-w-sm md:max-w-none md:w-auto md:h-[80vh] object-cover"
            />
          </div>
          
          {/* Right Column - Content */}
          <div className="w-full md:w-1/2 px-0 md:px-12 flex items-center md:ml-[-70px]">
