...
import etherapyImage from '../assets/etharepy.png';
import etherapyHome from '../assets/webdesignassets/eTherapyhome.png';
import etherapyMain from '../assets/webdesignassets/eTherapymain.png';
import etherapyMainDesign from '../assets/webdesignassets/eTherapymaindesign.png';
import etherapyFooter from '../assets/webdesignassets/eTherapyfooter.png';
      ...
      <div className="w-full max-w-full px-0 py-16 mx-0">
          ...
          <div className="w-full lg:w-1/2 mt-11">
            ...
            <div className="space-y-5">
              <div>
                ...
                <p className="text-[#143642]">28 December 2021</p>
              </div>
              ...
              <div>
                ...
                <p className="text-[#143642]">Healthcare & Wellness</p>
              </div>
              
              <div className="pt-4">
                <h3 className="text-lg font-semibold text-[#F87666]">Client</h3>
                <p className="text-[#143642]">ETherapy</p>
              </div>
        ...
        <div className="mt-16 space-y-4">
          ...
          <div className="w-full">
            <img 
              src={etherapyMain} 
              alt="ETherapy Main Page" 
              className="w-full h-auto"
            />
          </div>
          <div className="w-full">
            <img 
              src={etherapyMainDesign} 
              alt="ETherapy Design" 
              className="w-full h-auto"
            />
          </div>
